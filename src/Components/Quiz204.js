...
import quizData204 from "../QuizData/quizData204.json";
import {
  Typography,
  Paper,
  FormGroup,
...
const Quiz204 = () => {
  ...
  const [answerStatus, setAnswerStatus] = useState(
    Array(quizData204.length).fill(null)
  );
  ...
  const handleShowSolution = () => {
    ...
    const correctAnswers = quizData204[currentQuestionIndex].correctAnswer;
  ...
  const handleNextQuestion = () => {
    ...
    setAnswerStatus(Array(quizData204.length).fill(null));
  };
  ...
  const handleSearchQuestion = () => {
    ...
    if (!isNaN(questionNumber) && questionNumber >= 1 && questionNumber <= quizData204.length) {
      setCurrentQuestionIndex(questionNumber - 1);
      setSearchQuestionNumber("");
    } else {
      // Handle invalid input (e.g., display an error message)
      alert("Invalid question number. Please enter a valid question number between 1 and " + quizData204.length);
    }
  };
  

  const currentQuestion = quizData204[currentQuestionIndex];
  const showSolution = answerStatus[currentQuestionIndex] !== null;
  return (
    <div>
      <Navbar />
      <Paper elevation={3} className="quiz-container">
        <Typography variant="h4">AZ-204 </Typography>
        <div className="question-number">
          Question {currentQuestionIndex + 1} / {quizData204.length}
        </div>
          ...
          <div className="question-container">
            ...
            <div className="navigation-buttons">
              ...
              <Button
                ...
                disabled={
                  currentQuestionIndex === quizData204.length - 1 ||
        ...
        {currentQuestionIndex === quizData204.length && (
